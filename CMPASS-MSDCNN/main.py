...
model = Model(num_sensors=num_sensors, seq_length=seq_length, kernel_length_1=kernel_length_1, kernel_length_2=kernel_length_2, kernel_length_3=kernel_length_3, F_N=F_N, F_L1=F_L1, F_L2=F_L2, hidden_size=hidden_size, ).to(device)
