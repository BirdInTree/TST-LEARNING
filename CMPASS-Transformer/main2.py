...
from model import RMSELoss, weights_init, score, get_optimizer
...
x_plot = torch.tensor(x_plot).to(device)
...
train(model, optimizer, train_loader, x_val, y_val, num_epochs=1)
